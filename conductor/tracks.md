...
- [~] **BP Establishment Config — Schema migration (establishment_type, social_links, large_party_handling) + Dart model + 4 new BP edit sections + Marketplace display**
  ...
  - *Phases:* 4 — (1) Schema Migration + Dart Model Layer ✅, (2) BP UI: Type + Hours + Social ✅, (3) BP UI: Policy + Reservation Config ✅, (4) Marketplace Display + Verification (partial — deploy done, display deferred)
