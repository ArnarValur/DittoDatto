...
- **admin_panel_20260527** — Admin Panel Flutter breaker box. Deployed to Saturn at `http://saturn:8002`. Wired to real SurrealDB (namespace auth, dual-WS connections). All 5 screens implemented. Minor tweaks needed (non-blocking cleanup).
...
- _2026-05-29_ — Some minor tweaks needed from this deployment session — non-blocking cleanup. Details to be reviewed next session.
- _2026-05-29_ — Ask Arnar about the network setup / Tailscale FQDN resolution next session.
