---
title: "Vue Marquee Component"
source: "https://ui.nuxt.com/docs/components/marquee"
author:
  - "[[Nuxt UI]]"
published:
created: 2026-01-28
...
[GitHub](https://github.com/nuxt/ui/blob/v4/src/runtime/components/Marquee.vue)
...
| `orientation` | `'horizontal'` | ` "horizontal" \| "vertical"`  The orientation of the marquee. |
| `repeat` | `4` | ` number`  The number of times the marquee should repeat. |
...
[`1e624`](https://github.com/nuxt/ui/commit/1e6242ee99aa5b15ecbe314728be8d65dbcdfd66) — fix: move keyframes into global css

[`0cd0c`](https://github.com/nuxt/ui/commit/0cd0cd02c3f66e19aa8b8f50f7fb4e9238917ab6) — chore: improve tsdoc
...
[`18460`](https://github.com/nuxt/ui/commit/1846079c1e2c6da0f7fcacc619c9c82a081f86d5) — fix: handle RTL mode ([#4887](https://github.com/nuxt/ui/issues/4887))

[`b6edc`](https://github.com/nuxt/ui/commit/b6edce266281ef8448588f303e4d8e28c7adf6ea) — feat!: rename from `PageMarquee` ([#4741](https://github.com/nuxt/ui/issues/4741))[Empty](https://ui.nuxt.com/docs/components/empty)
