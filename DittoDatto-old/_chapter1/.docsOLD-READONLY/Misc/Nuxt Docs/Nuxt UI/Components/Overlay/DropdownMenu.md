---
title: "Vue DropdownMenu Component"
...
In this example, leveraging [`defineShortcuts`](https://ui.nuxt.com/docs/composables/define-shortcuts), you can toggle the DropdownMenu by pressing O.
...
In this example, Ctrl E, Ctrl I and Ctrl N would trigger the `select` function of the corresponding item.
...
| `arrow` | `false` | `boolean \| DropdownMenuArrowProps` |
...
[`ef861`](https://github.com/nuxt/ui/commit/ef86108f14da23fa292afe016517eac95c34bf76) — chore: add eol in script tag to fix syntax highlight[Drawer](https://ui.nuxt.com/docs/components/drawer)
