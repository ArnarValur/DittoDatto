---
title: "Vue InputMenu Component"
source: "https://ui.nuxt.com/docs/components/input-menu"
author:
  - "[[Nuxt UI]]"
published:
created: 2026-01-28
...
In this example, leveraging [`defineShortcuts`](https://ui.nuxt.com/docs/composables/define-shortcuts), you can toggle the InputMenu by pressing O.
...
<template>
  ...
  <UInputMenu ref="inputMenu" placeholder="Select user" :items="users" />
...
| `deleteIcon` | `appConfig.ui.icons.close` | `any`  The icon displayed to delete a tag. Works only when `multiple` is `true`. |
...
| `openOnClick` | `` `false` `` | `boolean `  Whether to open the combobox when the input is clicked |
| `openOnFocus` | `` `false` `` | `boolean `  Whether to open the combobox when the input is focused |
...
| `remove-tag` | `[item: GetModelValue<T, VK, M>]` |
...
[`02853`](https://github.com/nuxt/ui/commit/028538a728f9c1b4451aa94bb8f0b702b78fe568) — fix: ensure tag can be removed when number
...
[`9becc`](https://github.com/nuxt/ui/commit/9beccbb359f1f034b40195d999aee67cb4dd3c38) — fix: ensure to pass a string to items when multiple
...
[`77b6b`](https://github.com/nuxt/ui/commit/77b6b9ae8e876b03a5edc45a85e94b448c2c48e9) — fix: prevent `focus-outside` event on content
...
[`6ca7c`](https://github.com/nuxt/ui/commit/6ca7c8b7bfa248b586a8d4cd888c8e7d09267230) — feat: emit `remove-tag` event ([#4511](https://github.com/nuxt/ui/issues/4511))

[`cb160`](https://github.com/nuxt/ui/commit/cb160e697185482248c55fb1aa50779e339feb04) — fix: reset search term on mounted
...
[`54bb2`](https://github.com/nuxt/ui/commit/54bb2282c58d3bf5a7dde4cdee687c68efd934a0) — feat: new component ([#4261](https://github.com/nuxt/ui/issues/4261))
...
[`9d2fe`](https://github.com/nuxt/ui/commit/9d2fed125013e3bbfbf9435678729cd05254a5e8) — fix: emit `change` on multiple item removal
...
[`30746`](https://github.com/nuxt/ui/commit/3074632523e67fa6a0ad3d9a71e5692c285bdc3a) — fix: reset `searchTerm` on `update:open`
...
[`5dec0`](https://github.com/nuxt/ui/commit/5dec0e16e28549b8833aaab17a87fada63d6598c) — feat: handle events in `content` prop[InputDate](https://ui.nuxt.com/docs/components/input-date)
