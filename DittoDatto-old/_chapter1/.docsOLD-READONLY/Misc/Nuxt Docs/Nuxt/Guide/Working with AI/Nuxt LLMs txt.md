...
source: "https://nuxt.com/docs/4.x/guide/ai/llms-txt"
author:
  - "nuxt.com"
published:
created: 2026-02-08
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/3.guide/3.ai/2.llms-txt.md)[MCP Server](https://nuxt.com/docs/4.x/guide/ai/mcp)
