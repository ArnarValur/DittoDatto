---
title: "Understand Module Structure · Nuxt Modules Author Guide v4"
source: "https://nuxt.com/docs/4.x/guide/modules/module-anatomy"
author:
  - "nuxt.com"
published:
created: 2026-02-08
...
- "local" modules exist within a Nuxt project, either [inlined in Nuxt config](https://nuxt.com/docs/4.x/api/nuxt-config#modules) or within [the `modules` directory](https://nuxt.com/docs/4.x/directory-structure/modules).
...
You can get type hinting for this function using the higher-level `defineNuxtModule` helper provided by [Nuxt Kit](https://nuxt.com/docs/4.x/guide/going-further/kit).
...
You'll then be able to inject all those assets inside the application from your [module definition](https://nuxt.com/docs/4.x/guide/modules/#define-your-module).

Learn more about asset injection in [the recipes section](https://nuxt.com/docs/4.x/guide/modules/recipes-basics).
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/3.guide/4.modules/2.module-anatomy.md)[Create Your First Module](https://nuxt.com/docs/4.x/guide/modules/getting-started)
