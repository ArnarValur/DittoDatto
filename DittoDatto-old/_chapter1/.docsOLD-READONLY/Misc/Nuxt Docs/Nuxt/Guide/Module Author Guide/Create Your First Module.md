---
title: "Create Your First Module · Nuxt Modules Author Guide v4"
source: "https://nuxt.com/docs/4.x/guide/modules/getting-started"
author:
  - "nuxt.com"
published:
created: 2026-02-08
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/3.guide/4.modules/1.getting-started.md)[LLMs.txt](https://nuxt.com/docs/4.x/guide/ai/llms-txt)
