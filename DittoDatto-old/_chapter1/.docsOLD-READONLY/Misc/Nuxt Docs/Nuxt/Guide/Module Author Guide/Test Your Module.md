---
title: "Test Your Module · Nuxt Modules Author Guide v4"
...
Having a playground Nuxt application to test your module when developing it is really useful. [The module starter integrates one for that purpose](https://nuxt.com/docs/4.x/guide/modules/getting-started#develop-your-module).
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/3.guide/4.modules/5.testing.md)[Use Hooks & Extend Types](https://nuxt.com/docs/4.x/guide/modules/recipes-advanced)
