...
source: "https://nuxt.com/docs/4.x/guide/concepts/nuxt-lifecycle"
author:
  - "nuxt.com"
published:
created: 2026-02-08
...
Read more in Docs > 4 X > Directory Structure > Server#server Plugins.
...
Read more in Docs > 4 X > Directory Structure > Server#server Middleware.
...
Read more in Docs > 4 X > Getting Started > Routing#route Validation.
...
Read more in Docs > 4 X > Directory Structure > App > Middleware#when Middleware Runs.
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/3.guide/1.concepts/2.nuxt-lifecycle.md)[Rendering Modes](https://nuxt.com/docs/4.x/guide/concepts/rendering)
