...
source: "https://nuxt.com/docs/4.x/guide/going-further/experimental-features"
author:
  - "nuxt.com"
published:
created: 2026-02-08
...
Consider carefully before enabling this as it can cause unexpected behavior, and consider providing explicit keys to [`useState`](https://nuxt.com/docs/4.x/api/composables/use-state) as auto-generated keys may not match across builds.
...
Read more in Docs > 4 X > Directory Structure > App > Components#server Components.
...
This option enables enabling decorator syntax across your entire Nuxt/Nitro app, powered by .
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/3.guide/6.going-further/1.experimental-features.md)[Custom Events](https://nuxt.com/docs/4.x/guide/going-further/events)
