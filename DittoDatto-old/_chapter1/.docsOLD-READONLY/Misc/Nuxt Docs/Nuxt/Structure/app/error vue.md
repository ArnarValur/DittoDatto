...
source: "https://nuxt.com/docs/4.x/directory-structure/app/error"
author:
  - "nuxt.com"
published:
created: 2026-02-08
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/2.directory-structure/1.app/3.error.md)[app.config.ts](https://nuxt.com/docs/4.x/directory-structure/app/app-config)
...
](https://nuxt.com/docs/4.x/directory-structure/content)