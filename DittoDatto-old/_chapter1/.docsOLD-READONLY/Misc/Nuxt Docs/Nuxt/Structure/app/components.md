...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/2.directory-structure/1.app/1.components.md)[assets](https://nuxt.com/docs/4.x/directory-structure/app/assets)
