---
title: "Auto-imports · Nuxt Kit v4"
source: "https://nuxt.com/docs/4.x/api/kit/autoimports"
author:
  - "nuxt.com"
published:
created: 2026-02-08
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/5.kit/4.autoimports.md)[Compatibility](https://nuxt.com/docs/4.x/api/kit/compatibility)

[

Nuxt Kit provides a set of utilities to help you check the compatibility of your modules with different Nuxt versions.

](https://nuxt.com/docs/4.x/api/kit/compatibility)[
