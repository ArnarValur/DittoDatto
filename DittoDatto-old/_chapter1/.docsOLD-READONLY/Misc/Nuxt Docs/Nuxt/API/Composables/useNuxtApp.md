---
title: "useNuxtApp · Nuxt Composables v4"
source: "https://nuxt.com/docs/4.x/api/composables/use-nuxt-app"
author:
  - "nuxt.com"
published:
created: 2026-02-08
...
- [`directive()`](https://vuejs.org/api/application#app-directive) - Registers a global custom directive if passing both a name string and a directive definition, or retrieves an already registered one if only the name is passed [(example)](https://nuxt.com/docs/4.x/directory-structure/app/plugins#vue-directives).
- [`use()`](https://vuejs.org/api/application#app-use) - Installs a **[Vue.js Plugin](https://vuejs.org/guide/reusability/plugins)** [(example)](https://nuxt.com/docs/4.x/directory-structure/app/plugins#vue-plugins).
...
Read more in Docs > 4 X > Guide > Going Further > Experimental Features#asynccontext.
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/2.composables/use-nuxt-app.md)[useLoadingIndicator](https://nuxt.com/docs/4.x/api/composables/use-loading-indicator)
