...
GET `/v1/hq/transactions/{transaction_id}`
...
```
curl -X GET "https://api.noona.is/v1/hq/transactions/string"
```
...
Empty[Delete a transaction DELETE](https://docs.noona.is/docs/hq/transactions/DeleteTransaction)

[

Previous Page

](https://docs.noona.is/docs/hq/transactions/DeleteTransaction)[
