...
```
curl -X POST "https://api.noona.is/v1/hq/voucher_templates" \
...
Empty[Voucher Templates](https://docs.noona.is/docs/hq/voucher-templates)

[

Previous Page

](https://docs.noona.is/docs/hq/voucher-templates)[

Delete voucher template DELETE
