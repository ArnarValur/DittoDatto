...
GET `/v1/hq/companies/{company_id}/sms_messages`
...
```
curl -X GET "https://api.noona.is/v1/hq/companies/dwawd8awudawd/sms_messages"
```
...
```[List emails GET](https://docs.noona.is/docs/hq/messaging/ListEmails)
...
Retrieve aggregated customers data GET
