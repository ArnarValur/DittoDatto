...
POST `/v1/hq/resources/{resource_id}`
...
```
curl -X POST "https://api.noona.is/v1/hq/resources/dwawd8awudawd" \
...
```[Stream resource GET](https://docs.noona.is/docs/hq/resources/StreamResources)
