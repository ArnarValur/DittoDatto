...
GET `/v1/hq/resources/{resource_id}`
...
```
curl -X GET "https://api.noona.is/v1/hq/resources/string"
```
...
Empty[Delete resource DELETE](https://docs.noona.is/docs/hq/resources/DeleteResource)
