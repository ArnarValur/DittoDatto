...
POST `/v1/hq/event_types/{event_type_id}`
...
```
curl -X POST "https://api.noona.is/v1/hq/event_types/string" \
...
Empty[Stream event types GET](https://docs.noona.is/docs/hq/event-types/StreamEventTypes)
...
](https://docs.noona.is/docs/hq/events)