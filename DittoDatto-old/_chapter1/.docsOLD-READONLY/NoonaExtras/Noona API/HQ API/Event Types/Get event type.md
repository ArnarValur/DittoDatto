...
GET `/v1/hq/event_types/{event_type_id}`
...
```
curl -X GET "https://api.noona.is/v1/hq/event_types/string"
```
...
Empty[Delete event type DELETE](https://docs.noona.is/docs/hq/event-types/DeleteEventType)
