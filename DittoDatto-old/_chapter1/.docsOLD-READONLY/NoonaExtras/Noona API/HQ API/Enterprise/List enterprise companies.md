...
GET `/v1/hq/enterprise/{enterprise_id}/companies`
...
```
curl -X GET "https://api.noona.is/v1/hq/enterprise/string/companies"
```
...
Empty[Retrieve enterprise GET](https://docs.noona.is/docs/hq/enterprise/GetEnterprise)
