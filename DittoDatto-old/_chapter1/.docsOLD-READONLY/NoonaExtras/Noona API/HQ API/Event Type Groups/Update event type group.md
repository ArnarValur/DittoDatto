...
Updates event type group by ID

POST `/v1/hq/event_type_groups/{event_type_group_id}`
...
```
curl -X POST "https://api.noona.is/v1/hq/event_type_groups/string" \
...
Empty[Stream event type groups GET](https://docs.noona.is/docs/hq/event-type-groups/StreamEventTypeGroups)
