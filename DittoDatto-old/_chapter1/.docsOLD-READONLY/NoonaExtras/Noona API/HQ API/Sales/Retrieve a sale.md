...
```
curl -X GET "https://api.noona.is/v1/hq/sales/string"
```
...
Empty[Delete a sale DELETE](https://docs.noona.is/docs/hq/sales/DeleteSale)

[

Previous Page

](https://docs.noona.is/docs/hq/sales/DeleteSale)[
