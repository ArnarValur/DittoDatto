...
```
curl -X POST "https://api.noona.is/v1/hq/sales/string" \
...
Empty[Refund a marketplace sale POST](https://docs.noona.is/docs/hq/sales/RefundMarketplaceSale)
...
](https://docs.noona.is/docs/hq/saltpay)