...
```
curl -X GET "https://api.noona.is/v1/hq/user"
```
...
Empty[Confirm user email verification POST](https://docs.noona.is/docs/hq/user/ConfirmUserEmailVerification)

[

Previous Page

](https://docs.noona.is/docs/hq/user/ConfirmUserEmailVerification)[
