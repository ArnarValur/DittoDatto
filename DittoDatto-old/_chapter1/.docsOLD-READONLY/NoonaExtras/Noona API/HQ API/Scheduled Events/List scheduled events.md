...
tag: "noona.is"
---
Lists all scheduled events for a company.

GET `/v1/hq/companies/{company_id}/scheduled_events`
...
```
curl -X GET "https://api.noona.is/v1/hq/companies/dwawd8awudawd/scheduled_events"
```
...
Empty[Retrieve a scheduled event GET](https://docs.noona.is/docs/hq/scheduled-events/GetScheduledEvent)
...
Update a scheduled event POST

Next Page

](https://docs.noona.is/docs/hq/scheduled-events/UpdateScheduledEvent)