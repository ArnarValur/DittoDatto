...
tag: "noona.is"
---
Creates a scheduled event for a company.

POST `/v1/hq/scheduled_events`
...
```
curl -X POST "https://api.noona.is/v1/hq/scheduled_events" \
...
Empty[Scheduled Events](https://docs.noona.is/docs/hq/scheduled-events)

[

Previous Page

](https://docs.noona.is/docs/hq/scheduled-events)[
