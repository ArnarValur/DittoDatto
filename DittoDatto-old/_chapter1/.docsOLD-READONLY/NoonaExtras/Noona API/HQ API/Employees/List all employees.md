...
GET `/v1/hq/companies/{company_id}/employees`
...
```
curl -X GET "https://api.noona.is/v1/hq/companies/dwawd8awudawd/employees"
```
...
```[Retrieve an employee GET](https://docs.noona.is/docs/hq/employees/GetEmployee)
