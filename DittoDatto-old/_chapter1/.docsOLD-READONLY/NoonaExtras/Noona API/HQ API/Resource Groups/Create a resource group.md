...
```
curl -X POST "https://api.noona.is/v1/hq/resource_groups" \
...
Empty[Resource Groups](https://docs.noona.is/docs/hq/resource-groups)

[

Previous Page

](https://docs.noona.is/docs/hq/resource-groups)[
