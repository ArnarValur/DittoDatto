...
GET `/v1/hq/companies/{company_id}/resource_groups`
...
```
curl -X GET "https://api.noona.is/v1/hq/companies/dwawd8awudawd/resource_groups"
```
...
Empty[Retrieve a resource group GET](https://docs.noona.is/docs/hq/resource-groups/GetResourceGroup)
...
Update a resource group POST

Next Page

](https://docs.noona.is/docs/hq/resource-groups/UpdateResourceGroup)