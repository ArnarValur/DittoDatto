...
```
curl -X GET "https://api.noona.is/v1/hq/oauth/applications"
```
...
```[List application payouts GET](https://docs.noona.is/docs/hq/applications/ListOAuthApplicationPayouts)
