...
recurring\_event?| string

company?string |

[Expandable](https://api.noona.is/docs/working-with-the-apis/expandable_attributes)

employee\_name?string Deprecated
...
event\_date?string Deprecated

Deprecated, use starts\_at instead

Example `"2022-09-12"`

start\_time?string Deprecated

Deprecated, use starts\_at instead

Example `"15:30"`

end\_time?string Deprecated

Deprecated, use ends\_at instead
...
See [Event Statuses](https://docs.noona.is/docs/hq/events/#tag/Event-Statuses) for more information.

Example `"noshow"`

claim\_status?string
...
outstanding\_no\_show\_fee?number
...
```
curl -X POST "https://api.noona.is/v1/hq/events/dwawd8awudawd" \
...
Empty[Stream events GET](https://docs.noona.is/docs/hq/events/StreamEvents)
