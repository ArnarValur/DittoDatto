...
```
curl -X GET "https://api.noona.is/v1/hq/events/dwawd8awudawd"
```
...
Empty[Delete event file DELETE](https://docs.noona.is/docs/hq/events/DeleteEventFile)
