...
GET `/v1/hq/companies/{company_id}/activities`
...
```
curl -X GET "https://api.noona.is/v1/hq/companies/dwawd8awudawd/activities"
```
...
```[Activities](https://docs.noona.is/docs/hq/activities)

[

Previous Page

](https://docs.noona.is/docs/hq/activities)[

List activities for blocked time GET
