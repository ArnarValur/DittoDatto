...
tag: "noona.is"
---
[HQ API](https://docs.noona.is/docs/hq) [Activities](https://docs.noona.is/docs/hq/activities)

Lists activities for blocked time. Activities are sorted in descending order by occurrance.

GET `/v1/hq/activities/blocked_times/{blocked_time_id}`
...
```
curl -X GET "https://api.noona.is/v1/hq/activities/blocked_times/dwawd8awudawd"
```
...
```[List all activities at company GET](https://docs.noona.is/docs/hq/activities/ListAllCompanyActivities)

[

Previous Page

](https://docs.noona.is/docs/hq/activities/ListAllCompanyActivities)[

List activities for customer GET

Next Page

](https://docs.noona.is/docs/hq/activities/ListCustomerActivities)