...
GET `/v1/hq/activities/event_types/{event_type_id}`
...
```
curl -X GET "https://api.noona.is/v1/hq/activities/event_types/dwawd8awudawd"
```
...
```[List activities for event GET](https://docs.noona.is/docs/hq/activities/ListEventActivities)
...
List activities for payment GET

Next Page

](https://docs.noona.is/docs/hq/activities/ListPaymentActivities)