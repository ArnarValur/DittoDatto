...
GET `/v1/hq/activities/customers/{customer_id}`
...
```
curl -X GET "https://api.noona.is/v1/hq/activities/customers/dwawd8awudawd"
```
...
```[List activities for blocked time GET](https://docs.noona.is/docs/hq/activities/ListBlockedTimeActivities)

[

Previous Page

](https://docs.noona.is/docs/hq/activities/ListBlockedTimeActivities)[

List activities for event GET

Next Page

](https://docs.noona.is/docs/hq/activities/ListEventActivities)