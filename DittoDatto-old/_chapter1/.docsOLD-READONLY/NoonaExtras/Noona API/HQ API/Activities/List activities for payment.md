...
GET `/v1/hq/activities/payments/{payment_id}`
...
```
curl -X GET "https://api.noona.is/v1/hq/activities/payments/dwawd8awudawd"
```
...
```[List activities for event type GET](https://docs.noona.is/docs/hq/activities/ListEventTypeActivities)
...
](https://docs.noona.is/docs/hq/adyen)