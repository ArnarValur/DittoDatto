...
GET `/v1/hq/activities/events/{event_id}`
...
```
curl -X GET "https://api.noona.is/v1/hq/activities/events/dwawd8awudawd"
```
...
```[List activities for customer GET](https://docs.noona.is/docs/hq/activities/ListCustomerActivities)
...
List activities for event type GET

Next Page

](https://docs.noona.is/docs/hq/activities/ListEventTypeActivities)