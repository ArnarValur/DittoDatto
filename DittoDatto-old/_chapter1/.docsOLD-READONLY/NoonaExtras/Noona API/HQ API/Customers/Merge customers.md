...
Merges multiple customers into a target customer. This operation cannot be undone.

POST `/v1/hq/customers/{customer_id}/merge`
...
ID of the target customer to merge others into

## Request Body

application/json

customer\_ids \* array<string>
...
```
curl -X POST "https://api.noona.is/v1/hq/customers/string/merge" \
...
Empty[List all customers GET](https://docs.noona.is/docs/hq/customers/ListCustomers)
