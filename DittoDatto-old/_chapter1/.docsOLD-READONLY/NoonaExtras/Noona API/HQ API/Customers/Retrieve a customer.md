...
GET `/v1/hq/customers/{customer_id}`
...
```
curl -X GET "https://api.noona.is/v1/hq/customers/string"
```
...
Empty[Delete customer file DELETE](https://docs.noona.is/docs/hq/customers/DeleteCustomerFile)
