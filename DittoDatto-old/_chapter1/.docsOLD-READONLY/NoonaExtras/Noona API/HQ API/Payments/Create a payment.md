...
```
curl -X POST "https://api.noona.is/v1/hq/payments" \
...
```
{
  ...
  "code": "unableToProcessPayment"

}
```

Empty[Payments](https://docs.noona.is/docs/hq/payments)
