...
POST `/v1/hq/payments/{payment_id}`
...
```
curl -X POST "https://api.noona.is/v1/hq/payments/string" \
...
Empty[Send payment receipt POST](https://docs.noona.is/docs/hq/payments/SendPaymentReceipt)
...
Retrieve a list of permission groups GET

Next Page

](https://docs.noona.is/docs/hq/permission-groups/ListPermissionGroups)