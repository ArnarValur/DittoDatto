...
GET `/v1/hq/waitlist_entries/{waitlist_entry_id}`
...
```
curl -X GET "https://api.noona.is/v1/hq/waitlist_entries/string"
```
...
Empty[Delete a waitlist entry DELETE](https://docs.noona.is/docs/hq/waitlists/DeleteWaitlistEntry)
