...
POST `/v1/hq/waitlist_entries/{waitlist_entry_id}`
...
```
curl -X POST "https://api.noona.is/v1/hq/waitlist_entries/dwawd8awudawd" \
...
```[List all waitlist entries GET](https://docs.noona.is/docs/hq/waitlists/ListWaitlistEntries)

[

Previous Page

](https://docs.noona.is/docs/hq/waitlists/ListWaitlistEntries)[

Webhook Invocations

Next Page

](https://docs.noona.is/docs/hq/webhook-invocations)