...
GET `/v1/hq/companies/{company_id}/waitlist_entries`
...
```
curl -X GET "https://api.noona.is/v1/hq/companies/dwawd8awudawd/waitlist_entries"
```
...
```[Retrieve a waitlist entry GET](https://docs.noona.is/docs/hq/waitlists/GetWaitlistEntry)
...
Update a waitlist entry POST

Next Page

](https://docs.noona.is/docs/hq/waitlists/UpdateWaitlistEntry)