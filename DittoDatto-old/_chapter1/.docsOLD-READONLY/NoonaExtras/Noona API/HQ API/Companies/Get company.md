...
GET `/v1/hq/companies/{company_id}`
...
```
curl -X GET "https://api.noona.is/v1/hq/companies/string"
```
...
Empty[List all companies GET](https://docs.noona.is/docs/hq/companies/GetCompanies)
