...
POST `/v1/hq/companies/{company_id}`
...
An ID that can be used to reference the company in an external system. This ID is not used by Noona and is not guaranteed to be unique.
...
```
curl -X POST "https://api.noona.is/v1/hq/companies/string" \
...
Empty[Stream updates GET](https://docs.noona.is/docs/hq/companies/StreamUpdates)
...
](https://docs.noona.is/docs/hq/companies/UploadCompanyFile)