...
Creates a new company from basic information.

POST `/v1/hq/companies`
...
```
curl -X POST "https://api.noona.is/v1/hq/companies" \
...
Empty[Clone a company POST](https://docs.noona.is/docs/hq/companies/CloneCompany)
...
](https://docs.noona.is/docs/hq/companies/GetCompanies)