...
```
curl -X GET "https://api.noona.is/v1/marketplace/suggestions/vouchers"
```
...
```[List suggested companies GET](https://docs.noona.is/docs/marketplace/suggestions/ListSuggestedCompanies)
