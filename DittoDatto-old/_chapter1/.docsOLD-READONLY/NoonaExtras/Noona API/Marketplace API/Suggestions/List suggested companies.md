...
```
curl -X GET "https://api.noona.is/v1/marketplace/suggestions/companies"
```
...
```[Get suggested company type GET](https://docs.noona.is/docs/marketplace/suggestions/GetSuggestedCompanyType)

[

Previous Page

](https://docs.noona.is/docs/marketplace/suggestions/GetSuggestedCompanyType)[

List suggested vouchers GET

Next Page

](https://docs.noona.is/docs/marketplace/suggestions/ListSuggestedVouchers)