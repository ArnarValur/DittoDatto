...
```
curl -X GET "https://api.noona.is/v1/marketplace/vouchers/string"
```
...
```[Create a voucher V2 POST](https://docs.noona.is/docs/marketplace/vouchers/CreateVoucherV2)
...
](https://docs.noona.is/docs/marketplace/vouchers/ListVouchers)