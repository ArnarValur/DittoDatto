...
```
curl -X GET "https://api.noona.is/v1/marketplace/speedy_tables?start_date=2022-11-01&end_date=2022-11-03&lat=0.1&lng=0.1&radius=10000&cuisines=string&dietaries=string&price=0"
```
...
```[List speedy slots for appointment vertical GET](https://docs.noona.is/docs/marketplace/time-slots/ListSpeedySlots)
