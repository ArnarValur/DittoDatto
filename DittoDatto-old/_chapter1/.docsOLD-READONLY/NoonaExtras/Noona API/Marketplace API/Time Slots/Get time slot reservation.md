...
```
curl -X GET "https://api.noona.is/v1/marketplace/time_slot_reservations/dwawd8awudawd"
```
...
```[Delete time slot reservation DELETE](https://docs.noona.is/docs/marketplace/time-slots/DeleteTimeSlotReservation)
