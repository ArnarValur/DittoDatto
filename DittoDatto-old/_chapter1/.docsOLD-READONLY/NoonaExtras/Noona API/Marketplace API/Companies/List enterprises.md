...
```
curl -X GET "https://api.noona.is/v1/marketplace/enterprises"
```
...
```[Retrieve an enterprise GET](https://docs.noona.is/docs/marketplace/marketplace-enterprises/GetEnterpriseByUrlName)

[

Previous Page

](https://docs.noona.is/docs/marketplace/marketplace-enterprises/GetEnterpriseByUrlName)[
