...
Retrieves a company type from its url\_name (slug).

GET `/v1/marketplace/companies/{url_name}`
...
```
curl -X GET "https://api.noona.is/v1/marketplace/companies/john_salon"
```
...
```[Companies](https://docs.noona.is/docs/marketplace/marketplace-companies)
