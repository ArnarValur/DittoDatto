...
tag: "noona.is"
---
[Marketplace API](https://docs.noona.is/docs/marketplace) [Enterprises](https://docs.noona.is/docs/marketplace/marketplace-enterprises)

Retrieves an enterprise from its url\_name (slug).

GET `/v1/marketplace/enterprises/{url_name}`
...
```
curl -X GET "https://api.noona.is/v1/marketplace/enterprises/big_barber_shops"
```
...
```[Enterprises](https://docs.noona.is/docs/marketplace/marketplace-enterprises)

[

Previous Page

](https://docs.noona.is/docs/marketplace/marketplace-enterprises)[

List enterprises GET

Next Page

](https://docs.noona.is/docs/marketplace/marketplace-enterprises/ListEnterprises)