...
```
curl -X GET "https://api.noona.is/v1/marketplace/voucher_templates"
```
...
```[Get voucher template GET](https://docs.noona.is/docs/marketplace/voucher-templates/GetVoucherTemplate)

[

Previous Page

](https://docs.noona.is/docs/marketplace/voucher-templates/GetVoucherTemplate)[

List voucher templates GET

Next Page

](https://docs.noona.is/docs/marketplace/voucher-templates/ListVoucherTemplates)