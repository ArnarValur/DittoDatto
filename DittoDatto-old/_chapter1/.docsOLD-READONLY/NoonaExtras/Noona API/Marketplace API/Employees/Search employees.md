...
```
curl -X GET "https://api.noona.is/v1/marketplace/employees"
```
...
```[List employees GET](https://docs.noona.is/docs/marketplace/employees/ListEmployees)

[

Previous Page

](https://docs.noona.is/docs/marketplace/employees/ListEmployees)[
