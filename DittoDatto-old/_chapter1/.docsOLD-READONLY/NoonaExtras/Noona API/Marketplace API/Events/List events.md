...
```
curl -X GET "https://api.noona.is/v1/marketplace/events"
```
...
```[Retrieve an event GET](https://docs.noona.is/docs/marketplace/marketplace-events/GetEvent)

[

Previous Page

](https://docs.noona.is/docs/marketplace/marketplace-events/GetEvent)[
