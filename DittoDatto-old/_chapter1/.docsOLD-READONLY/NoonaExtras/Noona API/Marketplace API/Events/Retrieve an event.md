...
```
curl -X GET "https://api.noona.is/v1/marketplace/events/dwawd8awudawd"
```
...
```[Send a notification for an event POST](https://docs.noona.is/docs/marketplace/marketplace-events/CreateEventNotification)
