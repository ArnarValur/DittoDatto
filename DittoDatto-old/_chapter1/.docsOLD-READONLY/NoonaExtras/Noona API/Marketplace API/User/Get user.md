...
```
curl -X GET "https://api.noona.is/v1/marketplace/user"
```
...
```[Request account deletion DELETE](https://docs.noona.is/docs/marketplace/marketplace-user/DeleteUser)
...
List user categories GET

Next Page

](https://docs.noona.is/docs/marketplace/marketplace-user/ListUserCategories)