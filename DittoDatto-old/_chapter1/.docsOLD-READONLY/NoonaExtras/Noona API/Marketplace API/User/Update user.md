...
favorite\_companies?array<string>
...
See [https://github.com/react-native-device-info/react-native-device-info](https://github.com/react-native-device-info/react-native-device-info) for more info.

## Response Body

```
curl -X POST "https://api.noona.is/v1/marketplace/user" \
