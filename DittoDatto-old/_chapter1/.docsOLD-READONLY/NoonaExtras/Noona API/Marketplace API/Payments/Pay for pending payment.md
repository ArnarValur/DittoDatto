...
```
curl -X POST "https://api.noona.is/v1/marketplace/user/payments/string/pay" \
...
```[List user payments GET](https://docs.noona.is/docs/marketplace/payments/ListPayments)

[

Previous Page

](https://docs.noona.is/docs/marketplace/payments/ListPayments)[

Resolves a payment GET

Next Page

](https://docs.noona.is/docs/marketplace/payments/PaymentResolve)