...
```
curl -X GET "https://api.noona.is/v1/marketplace/companies/string/event_types/expanded"
```
...
```[List event types GET](https://docs.noona.is/docs/marketplace/event-types/ListEventTypes)

[

Previous Page

](https://docs.noona.is/docs/marketplace/event-types/ListEventTypes)[

Search event types GET

Next Page

](https://docs.noona.is/docs/marketplace/event-types/SearchEventTypes)