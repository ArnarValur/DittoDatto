...
```
curl -X GET "https://api.noona.is/v1/marketplace/event_types"
```
...
```[List event types and groups GET](https://docs.noona.is/docs/marketplace/event-types/ListEventTypesExpanded)
